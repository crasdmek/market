...
if __name__=="__main__":
    ...
    tests = []
    tests.append('testworlds/world01.csv')
    tests.append('testworlds/world02.csv')
    tests.append('testworlds/world03.csv')
    tests.append('testworlds/world04.csv')
    tests.append('testworlds/world05.csv')
    tests.append('testworlds/world06.csv')
    tests.append('testworlds/world07.csv')
    tests.append('testworlds/world08.csv')
    tests.append('testworlds/world09.csv')
    tests.append('testworlds/world10.csv')
