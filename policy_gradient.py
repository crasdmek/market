...
def main():
    try:
        ...
        env = Market(initial_cash = 10000, commission = 9.99)
        rewards = []
        ...
        df.plot()
        agent.model.save_weights('pg.h5')
